...
namespace PetalOrSomething.Controllers
{
    public class ProductsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Price,Link3D,Stocks,Image,Category,CreatedDate,UpdatedDate,IsActive")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
